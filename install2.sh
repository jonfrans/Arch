...
pacman -Syu efibootmgr networkmanager man intel-ucode power-profiles-daemon noto-fonts-emoji noto-fonts-cjk noto-fonts ttf-space-mono-nerd otf-font-awesome lib32-nvidia-utils wine wine-gecko wine-mono gamemode mangohud steam 7zip btop numlockx unrar neofetch --noconfirm 
