...
case $choice in
  Y | y)
   echo "Particionando" &
   parted /dev/sda --script mklabel gpt mkpart P1 fat32 1MiB 1GiB mkpart P2 xfs 1GiB 46GiB mkpart P3 xfs 46GiB 100%
  ...
  N | n)
   ...
   ;;
   "")
   parted /dev/sda --script mklabel gpt mkpart P1 fat32 1MiB 1GiB mkpart P2 xfs 1GiB 46GiB mkpart P3 xfs 46Gi
   parted /dev/sda --script set 1 esp on set 2 root on set 3 linux-home on
