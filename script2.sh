...
pacman -Sy efibootmgr networkmanager man intel-ucode btop nvidia-dkms libva-utils libva-nvidia-driver libvdpau-va-gl git base-devel neofetch noto-fonts-emoji noto-fonts-cjk noto-fonts wine wine-gecko wine-mono gamemode mangohud --noconfirm && systemctl enable NetworkManager
