...
pacman -S efibootmgr networkmanager intel-ucode nvidia-dkms git base-devel neofetch noto-fonts-emoji noto-fonts-cjk noto-fonts --noconfirm && systemctl enable NetworkManager
